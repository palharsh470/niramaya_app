...
export default function VoiceSupport() {
  ...
  const handleQuickCommand = (command: QuickCommand) => {
    ...
    Alert.alert(
      t.voiceCommandReceived,
      `${language === 'english' ? 'Command: ' : 'कमांड: '}"${commandText}"\n\n${language === 'english' ? 'Response: ' : 'जवाब: '}${mockResponses[command.id as keyof typeof mockResponses]}`,
      [
        {
          text: t.speakAnswer,
          onPress: () => Alert.alert(t.textToSpeech, t.answerSpoken)
              ...
              {quickCommands.map((command, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <LinearGradient
                        colors={command.gradientColors as [string, string, ...string[]]}
                ...
                >
                  ...
                  >
                    <View style={styles.faqHeader}>
                      <LinearGradient
                        colors={faq.gradientColors as [string, string, ...string[]]}
